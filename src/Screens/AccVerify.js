...
const AccVerify = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const response = await fetch(`https://backend-peackock.onrender.com/api/accverify/${email}`, {
            method: "POST",
            headers: {
    ...
    return (
        <div className='grid place-items-center h-screen'>
            ...
            <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700  ">
                <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white text-center">AccVerify Code</h5>
